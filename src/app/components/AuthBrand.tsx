...
export default function AuthBrand() {
  return (
    <div className="hidden lg:flex lg:w-[45%] xl:w-[42%] relative overflow-hidden flex-col justify-between p-10 gradient-primary">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 h-80 rounded-full bg-black/10" aria-hidden="true" />
      {/* Top: Logo */}
      <div className="relative z-10 flex items-center gap-3">
        <AppLogo size={40} />
        <div className="flex flex-col">
          <span className="font-800 text-lg text-primary-foreground leading-tight">TewahidoAcademy</span>
      ...
      <div className="relative z-10 space-y-6">
        ...
        <div className="w-16 h-16 flex items-center justify-center">
          <span className="text-5xl text-accent" aria-label="Ethiopian Orthodox Cross">✞</span>
        </div>

        <blockquote className="space-y-3">
          <p className="text-2xl font-700 text-primary-foreground leading-snug">
            "Learn the faith of your fathers,<br />in the language of your heart."
          </p>
          <p className="font-ethiopic text-lg text-white/80">
            "የአባቶቻችሁን እምነት ተማሩ"
          </p>
        </blockquote>
