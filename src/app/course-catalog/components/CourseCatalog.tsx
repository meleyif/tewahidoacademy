...
const COURSES: Course[] = [
  {
    ...
    description_en:
      'A comprehensive introduction to the Ethiopian Orthodox Tewahido Church — its history, theology, liturgy, and spiritual practices for diaspora families.',
    description_am:
      'ለዲያስፖራ ቤተሰቦች የኢትዮጵያ ኦርቶዶክስ ተዋሕዶ ቤተ ክርስቲያን ታሪክ፣ ሥነ-መለኮት፣ ቅዳሴ እና መንፈሳዊ ልምምዶች ሁሉን አቀፍ መግቢያ።',
  ...
  },
  {
    ...
    description_en:
      "Master the ancient Ge'ez script and pronunciation used in Ethiopian Orthodox liturgy, prayers, and sacred texts.",
    description_am:
      'በኢትዮጵያ ኦርቶዶክስ ቅዳሴ፣ ጸሎቶች እና ቅዱሳን ጽሑፎች ውስጥ ጥቅም ላይ የሚውለውን ጥንታዊ የግዕዝ ፊደልና አጠራር ይማሩ።',
  ...
  },
  {
    ...
    description_en:
      'Learn the traditional Ethiopian Orthodox hymns — Deggua and Zimare — with audio guides, notation, and live practice sessions.',
    description_am:
      'ባህላዊ የኢትዮጵያ ኦርቶዶክስ ዝማሬዎችን — ዲጋ እና ዝማሬ — በድምፅ መመሪያዎች፣ ምልክቶች እና ቀጥታ የልምምድ ክፍሎች ይማሩ።',
  ...
  },
  {
    ...
    description_en:
      'An engaging, age-appropriate introduction to Ethiopian Orthodox faith for students aged 11–14, with games, stories, and short video lessons.',
    description_am:
      'ከ11–14 ዓመት ለሆኑ ተማሪዎች ተስማሚ የኢትዮጵያ ኦርቶዶክስ እምነት መግቢያ፣ ጨዋታዎች፣ ታሪኮች እና አጭር የቪዲዮ ትምህርቶች።',
  ...
  },
  {
    ...
    description_en:
      'Understand the theology and practice of fasting in the Ethiopian Orthodox tradition — the 250+ fasting days, their meaning, and how to observe them.',
    description_am:
      'በኢትዮጵያ ኦርቶዶክስ ወግ ውስጥ ያለውን የጾም ሥነ-መለኮት እና ልምምድ ይረዱ — 250+ የጾም ቀናት፣ ትርጉማቸው እና እንዴት እንደሚጠበቁ።',
    instructor: 'Deaconess Miriam Tadesse',
  ...
  },
  {
    ...
    description_en:
      'A structured curriculum for those preparing for ordination as deacons in the Ethiopian Orthodox Church — liturgy, canon law, and pastoral duties.',
    description_am:
      'በኢትዮጵያ ኦርቶዶክስ ቤተ ክርስቲያን ዲቁና ለሹመት ለሚዘጋጁ ሰዎች ቅዳሴ፣ ቀኖና ሕግ እና የሐዋርያዊ ተግባራት ስርዓተ ትምህርት።',
    instructor: 'Deacon Dawit Bekele',
  ...
  },
  {
    ...
    description_en:
      'Explore the lives of Ethiopian Orthodox saints — from St. Yared to Abune Tekle Haymanot — and their enduring spiritual legacy.',
    description_am:
      'ቅዱስ ያሬድ ጀምሮ አቡነ ተክለ ሃይማኖት ድረስ ያሉ የኢትዮጵያ ኦርቶዶክስ ቅዱሳን ሕይወት እና ዘላቂ መንፈሳዊ ቅርሳቸውን ያስሱ።',
    instructor: 'Memhir Girma Haile',
    thumbnail: 'https://img.rocket.new/generatedImages/rocket_gen_img_115551440-1766597517501.png',
    thumbnailAlt:
      'Ancient Ethiopian Orthodox church interior with colorful murals and religious iconography',
    target_group: 'high',
    price_usd: null,
    totalLessons: 14,
    enrolledCount: 221,
  ...
  },
  {
    ...
    description_en:
      'A deep-dive into the Ethiopian Orthodox Divine Liturgy (Kidasie) — its structure, prayers, anaphoras, and theological significance.',
      ...
      <div className="flex flex-col flex-1 p-4 gap-3">
        <div>
          <div className="flex items-center gap-1.5 mb-1.5">
            <Badge
              variant={course.target_group === 'all' ? 'college' : (course.target_group as any)}
            >
              {t(`catalog.${course.target_group}`)}
            </Badge>
          </div>
          <h3
            className={`text-sm font-700 text-foreground leading-snug line-clamp-2 ${isAmharic ? 'font-ethiopic' : ''}`}
          >
            {title}
          </h3>
          <p
            className={`text-xs text-muted-foreground mt-1 line-clamp-2 leading-relaxed ${isAmharic ? 'font-ethiopic' : ''}`}
          >
            {description}
          </p>
        </div>
...
export default function CourseCatalog() {
  ...
  const filteredCourses = useMemo(() => {
    return COURSES.filter((course) => {
      const matchesGroup =
        activeGroup === 'all' ||
        course.target_group === activeGroup ||
